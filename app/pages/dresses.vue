...
<template>
  <div class="bg-white-900 py-16">
    <div class="container mx-auto px-4">
      <h2 class="text-3xl font-bold text-blak mb-8">Introducing Our Latest Product</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white rounded-lg shadow-lg p-8">
          <div class="relative overflow-hidden">
            <img class="object-cover w-full h-full" src="https://i.pinimg.com/736x/db/53/46/db534632c362d9a6ff6e21680888c0a7.jpg" alt="Product">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
          <div class="relative overflow-hidden">
            <img class="object-cover w-full h-full" src="https://cdn.shopify.com/s/files/1/0576/4893/products/sonia_dress_fronty_2400x.jpg?v=1569073982" alt="Product">
            <div class="absolute inset-0 bg-black opacity-40"></div>
            <div class="absolute inset-0 flex items-center justify-center">
              <button class="bg-white text-gray-900 py-2 px-6 rounded-full font-bold hover:bg-gray-300">View Product</button>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
          <div class="relative overflow-hidden">
            <img class="object-cover w-full h-full" src="https://i.pinimg.com/736x/44/33/13/44331360b5907734f32d98e0012d4d44.jpg" alt="Product">
            <div class="absolute inset-0 bg-black opacity-40"></div>
            <div class="absolute inset-0 flex items-center justify-center">
              <button class="bg-white text-gray-900 py-2 px-6 rounded-full font-bold hover:bg-gray-300">View Product</button>
            </div>
      ...
      <div class="flex flex-col md:flex-row -mx-4">
        <div class="md:flex-1 px-4">
          <div class="h-[460px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
            <img class="w-full h-full object-cover" src="https://th.bing.com/th/id/R.84b892d6314b97ae0edbbfccd4cb8eea?rik=SHg1WZeM5gJOmg&riu=http%3a%2f%2fnatalet.com%2fimages%2fpurple-gowns%2fpurple-gowns-18-8.jpg&ehk=S80w3%2fJ2MIg57w2etj5giT2%2flsjXdka94Qa3HvCjUPo%3d&risl=&pid=ImgRaw&r=0" alt="Product Image">
          </div>
